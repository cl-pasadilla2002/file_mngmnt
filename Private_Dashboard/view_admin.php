...
<html lang="en">
    ...
    <header>
        ...
        <div class="sidebar-fixed position-fixed" style="background-color: #F0F0F0;">
            ...
            <div class="list-group list-group-flush">
                ...
                <!-- VIEW ADMIN -->
                <a href="view_admin.php" class="list-group-item active waves-effect shadow">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align='center' width="10%">
                                <a href="#modalRegisterFormsss?id=<?php echo $id;?>">
                                    <i class="fas fa-user-edit" data-toggle="modal" data-target="#modalRegisterFormsss"></i> 
                                </a> | 
    ...
    <div class="modal fade" id="modalRegisterFormsss" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <?php 
        require_once("include/connection.php");
        ...
        <div class="modal-dialog" role="document">
            <form method="POST">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h4 class="modal-title w-100 font-weight-bold">
                            <i class="fas fa-user-edit"></i> Edit Admin Information
                        </h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    ...
                    <div class="modal-body mx-3">
                        ...
                        <div class="md-form mb-5">
                            <i class="fas fa-envelope prefix grey-text"></i>
                            <input type="email" id="orangeForm-email-Edit" name="admin_user" value="<?php echo $admin1;?>" class="form-control validate">
                            <label data-error="INCORRECT" data-success="CORRECT" for="orangeForm-email-Edit">EMAIL</label>
                        </div>
                        <!-- Material Input Edit Password -->
                        <div class="md-form mb-4">
                            <i class="fas fa-lock prefix grey-text"></i>
                            <input type="password" id="orangeForm-pass-Edit" name="admin_password" value="<?php echo $pass1;?>" class="form-control validate">
                            <!-- For Password Toggle --> 
