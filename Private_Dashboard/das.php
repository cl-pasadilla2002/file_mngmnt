...
<html lang="en">
    ...
    <head>
        ...
        <title>User Logged History</title>
    ...
    <header>
        ...
        <!-- Sidebar Start Here -->
        <div class="sidebar-fixed position-fixed" style="background-color: #3D59AB;">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="user_log.php" class="list-group-item active waves-effect shadow">
