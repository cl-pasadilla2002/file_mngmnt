            ...
            <div class="row wow fadeIn">
                ...
                <div class="col-md-3 mb-4">
                    ...
                    var myPieChart = new Chart(ctxP, {
                        type: 'pie',
                        data: {
                            labels: ["Red", "Blue", "Yellow", "Green", "Grey", "Dark Grey"],
                            datasets: [{
                                data: [500, 200, 100, 100, 100],
                                backgroundColor: ["#FB8890", "#A4CEF5", "#FFD98C", "#A1BB7C", "#4D5360"],
                                hoverBackgroundColor: ["#FF5A5E", "#4E71D8", "#FFC870", "#688243", "#616774"]
                            }]
                        },
                        options: {
                            responsive: true,
