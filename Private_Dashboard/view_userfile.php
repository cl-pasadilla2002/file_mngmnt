...
<html lang="en">
    ...
    <header>
        ...
        <div class="sidebar-fixed position-fixed" style="background-color: #F0F0F0;">
            ...
            <div class="list-group list-group-flush">
                ...
                <!-- VIEW USER FILE -->
                <a href="view_userfile.php" class="list-group-item active waves-effect shadow">
    ...
    <a href="add_files.php"><button type="button" class="btn btn-default" style="background-color: #688243 !important; color: white;"><i class="fas fa-file-medical"></i>  Add File</button></a>
</div>
            ...
            <div class="card col-md-12">
                <table id="dtable" class = "table table-striped">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <tdstyle="white-space: nowrap; max-width: <?php echo $maxWidth = 280;  ?>px; overflow: hidden; text-overflow: ellipsis;"><?php echo  $name; ?></td>
